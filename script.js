...
function signout(){
    ...
    r.onreadystatechange = function(){
        if(r.readyState == 4 && r.status == 200){
            ...
            if(t == "success" || t == "AdminLogOutSuccess"){
                console.log("nooo wayyy")
...
function showPassword3(){
    var iup = document.getElementById("iup");
    var up = document.getElementById("up");

    if(iup.type == "password"){
        iup.type = "text";
        up.innerHTML = '<i class="bi bi-eye-slash-fill"></i>';
    }else{
        iup.type = "password";
        up.innerHTML = '<i class="bi bi-eye-fill"></i>';
    }
}
...
function updateProfile(){
    ...
    var password = document.getElementById("iup");
 ...
 function loadBrands(){
    ...
    function changeProductImage(){
        ...
        images.onchange = function(){
           var file_count = images.files.length; //count the no. of images
           ...
           if(file_count <=3 ){
            ...
            alert(file_count + "files uploaded. Upload 3 or less than 3 files");
           }
        }
    }
...
function changeMainImg(id){
        ...
        r.onreadystatechange = function(){
            if (r.status == 200 && r.readyState == 4){
                ...
                if(t=="success"){
                    ...
                    if(confirm("You have not updated Images. Want to continue?") == true){
                        window.location = "myProducts.php";
                    }else{
                        alert("Select Images");
                    }
        ...
        r.onreadystatechange = function(){
            if(r.status == 200 && r.readyState == 4){
                ...
                if(t == "Added"){
                    ...
                    alert("Product removed from the watchlist successfully");
                    window.location.reload();
                }else{
                    alert(t);
                }
   ...
   function changeshipping(){
    ...
    var displaytext = document.getElementById("shipping");
   ...
   function paynow(pid){
    ...
    payhere.onCompleted = function onCompleted(orderId) {
        ...
        saveInvoice(orderId,pid,umail,amount,qty,owner_mail);
    ...
    var payment = {
        "sandbox": true,
        "merchant_id": "1224457",    // Replace your Merchant ID
        "return_url": "http://localhost/glamour/singleproductview.php?id=" + pid,   // Important
        "cancel_url": "http://localhost/glamour/singleproductview.php?id=" + pid,     // Important
...
function saveInvoice(orderId,pid,umail,amount,qty,owner_mail){
