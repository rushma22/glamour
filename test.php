                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            ...
                            if ($image_num == 0) {
                            ?>
                                <img src="img/girl1" style="height: 100px;margin-left: 80px;" />
                            <?php
                            } else {
                                $image_data = $image_rs->fetch_assoc();
                            ?>
                                <img src="<?php echo $image_data["img_path"]; ?>" style="height: 150px;margin-left: 50px;" />
                            <?php
                            }
                        ...
                        <div class="col-4 col-lg-2 bg-primary py-2">
                            <span class="fs-5 fw-bold text-white"><?php echo $selected_data["title1"]; ?></span>
                        </div>
                        <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
