...
<body style="background-color:#fd6bff;background-image: linear-gradient(90deg,#fd6bff 0%,#eab0ff 100%);" >
                                                        ...
                                                        <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-white rounded-0 bg-primary">
                                                                ...
                                                                <div class="media">
                                                                    ...
                                                                    ?>
                                                                        <img src="resource//person.svg" width="50px" class="rounded-circle">
                                                                    <?php
                                                                    }
