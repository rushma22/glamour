    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice` WHERE `owner_email`='" . $mail . "'");
                        ...
                        <div class="col-12 border border-1 border-primary rounded mb-2">
                            <div class="row">
                                ...
                                <div class="col-12 text-center" style="background-image: linear-gradient(to right, rgb(174, 0, 174) , rgba(64, 0, 109, 0.353));">
                                    <label class="form-label fs-1 fw-bolder text-light">My Sellings</label>
                                </div>
                                 ...
                                 if($invoice_num ==0){
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                <th  class="fs-4" scope="col">ORDER ID</th>
                                                ...
                                                <th  class="fs-4" scope="col">PURCHASED BY</th>
                                            ...
                                            for($x = 0; $x < $invoice_num; $x++){
                                                ...
                                                //for($x = 0; $x < $product_num;  $x++){
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td class="fs-5  pt-5"><?php echo $invoice_data["users_email"] ?></td>
